  ...
  return (
    <div className="shadow-sm border-b bg-white sticky top-0">
      ...
      <div className="flex justify-between max-w-6xl mx-5 xl:mx-auto">
        <div
          onClick={() => router.push("/")}
          className="relative hidden lg:inline-grid h-14 w-28"
        >
          <Image
            className="w-24 h-14"
          ...
          {session ? (
            <>
              <div className="relative navBtn">
                ...
                <div className="absolute -top-2 -right-2 text-xs w-5 h-5 bg-red-500 rounded-full flex items-center justify-center animate-pulse  "></div>
              </div>
              <PlusCircleIcon
